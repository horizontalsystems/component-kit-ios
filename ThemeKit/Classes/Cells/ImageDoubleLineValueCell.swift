...
open class ImageDoubleLineValueCell: ThemeCell {
    ...
    open func bind(image: UIImage?, title: String?, subtitle: String?, value: String?, valueHighlighted: Bool = false, last: Bool = false) {
